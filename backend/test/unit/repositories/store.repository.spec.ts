...
describe('StoreRepository', () => {
  ...
  describe('findStoreByName', () => {
    ...
    it('should return null when store not found by name', async () => {
  ...
  describe('inherited BaseRepository methods', () => {
    ...
    describe('createEntity', () => {
      it('should create and save new store', async () => {
        const createData = { name: 'New Store', description: 'A new store' };
  ...
  describe('edge cases', () => {
    ...
    it('should handle unicode characters in store names', async () => {
