...
export const API_ENDPOINTS = {
  ...
  USERS: {
    ...
    FIND_ONE: '/users/:id',
    UPDATE: '/users/:id',
    DASHBOARD: '/users/:id/dashboard',
    DELETE: '/users/:id',
    PROFILE: '/users/profile',
    PROFILE_STATS: '/users/profile/stats',
    PROFILE_ORDERS: '/users/profile/orders',
    UPDATE_PROFILE: '/users/profile',
    GET_USER_PROFILE: '/users/:id/profile',
    GET_MY_PROFILE: '/users/profile',
  ...
  AI_GENERATOR: {
    ...
    GENERATE_POST: '/stores/:storeId/ai/generator/posts',
